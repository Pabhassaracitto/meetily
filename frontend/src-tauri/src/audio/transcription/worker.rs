                        ...
                        Some(chunk) => {
                            ...
                            .await
                            {
                                Ok((transcript, confidence_opt, is_partial)) => {
                                    ...
                                    info!("🔍 Worker {} transcription result: text_length={}, confidence={}, partial={}, threshold={:.2}",
        ...
        TranscriptionEngine::Whisper(whisper_engine) => {
                ...
                .await
            {
                Ok((text, confidence, is_partial)) => {
                    ...
                    info!(
                        "Whisper transcription complete for chunk {}: text_length={} (confidence: {:.2}, partial: {})",
                        chunk.chunk_id,
        ...
        TranscriptionEngine::Parakeet(parakeet_engine) => {
            match parakeet_engine.transcribe_audio(speech_samples).await {
                Ok(text) => {
                    ...
                    info!(
                        "Parakeet transcription complete for chunk {}: text_length={}",
                        chunk.chunk_id,
                        cleaned_text.chars().count()
                    );
        ...
        TranscriptionEngine::Provider(provider) => {
            ...
            match provider.transcribe(speech_samples, language).await {
                Ok(result) => {
                    ...
                    info!(
                        "{} transcription complete for chunk {}: text_length={} ({}, partial: {})",
