...
/// Learning-focused template for lectures, workshops, and online classes.
pub const ONLINE_CLASS: &str = include_str!("../../../templates/online_class.json");

/// Evidence-aware template for Buddhist Dharma talks and study sessions.
pub const DHARMA_TALK: &str = include_str!("../../../templates/dharma_talk.json");
...
pub fn get_builtin_template(id: &str) -> Option<&'static str> {
    match id {
        ...
        "online_class" => Some(ONLINE_CLASS),
        "dharma_talk" => Some(DHARMA_TALK),
        _ => None,
    }
}
...
pub fn list_builtin_template_ids() -> Vec<&'static str> {
    vec!["daily_standup", "standard_meeting", "online_class", "dharma_talk"]
}
...
mod tests {
    ...
    fn test_get_builtin_template() {
        ...
        assert!(get_builtin_template("online_class").is_some());
        assert!(get_builtin_template("dharma_talk").is_some());
